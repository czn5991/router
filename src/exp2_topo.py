...
if __name__ == '__main__':
    ...
    h2.cmd('ifconfig h2-eth0 10.0.5.55/24')
    ...
    r4.cmd('ifconfig r4-eth1 10.0.4.2/24')
    r4.cmd('ifconfig r4-eth0 10.0.5.1/24')
    r4.cmd('route add -net 10.0.1.0 netmask 255.255.255.0 gw 10.0.4.1 dev r4-eth1')
    r4.cmd('route add -net 10.0.6.0 netmask 255.255.255.0 gw 10.0.4.1 dev r4-eth1')
